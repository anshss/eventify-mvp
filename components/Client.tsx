  ...
  <>
    <p className="mb-12 text-center text-lg text-white md:text-xl">
      <span className="text-primary-text">
        Backed by the world’s best product teams.
      </span>
      <br className="hidden md:block" /> Potential leaders of web 2.5 industry
    </p>
    ...
    <div className="flex flex-wrap justify-around gap-x-6 gap-y-8 [&_svg]:max-w-[16rem] [&_svg]:basis-[calc(50%-12px)] md:[&_svg]:basis-[calc(16.66%-20px)]">
      ...
      <Image src={lawbriefcase} alt="/polygon.png" height={90} width={150} className="ml-6 hidden md:block"/>
      ...
      <Image src={chillinq} alt="/polygon.png" height={50} width={170} className="ml-6 hidden md:block"/> 
